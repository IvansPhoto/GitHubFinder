...
let searchResult = [
	...
	},
	{
		'textMatches': [
			{
				'fragment': 'Motivated to learn, enthusiastic to collaborate, love hacking stuff together and telling impostor syndrome to screw off.\r\nThanks,\r\n@pdxnode\r\n@bradtraversy',
				'property': 'profile_bio'
			}
		]
	},
	{
		'textMatches': [
			{
				'fragment': 'Budding Developer dedicated to learning and helping clients leverage new technologies and industry standards - Loyal student of @bradtraversy',
				'property': 'profile_bio'
			}
		]
	},
	{
		'textMatches': [
			{
				'fragment': 'I am a full stack developer and I am huge bradtraversy fangirl. Specializing in JavaScript/Node.js and mobile development technologies',
				'property': 'profile_bio'
			}
		]
	},
	...
	},
	{
		'textMatches': [
			{
				'fragment': 'I am 24, and have been teaching myself web development since the end of 2018, with the help of courses by creators like @bradtraversy and @wesbos',
				'property': 'profile_bio'
			}
		]
	},
	{
		'textMatches': [
			{
				'fragment': 'Passionate Programmer💻, quick learner like to explore technologies and a fond of cricket. 🏏\r\n\r\nStudent at Traversy Media  (@bradtraversy)💖\r\n',
				'property': 'profile_bio'
			}
		]
	},
	{
		'textMatches': [
			{
				'fragment': 'knows basic Html and CSS. Currently doing some "freecodecamp" projects.I will upload more repositories...  Check out @bradtraversy & @QuincyLarson ',
				'property': 'profile_bio'
			}
		]
	},
	{
		'textMatches': [
			{
				'fragment': 'I\'m learning web and mobile app development,@bradtraversy taught me what is git and how to use it. Thanks mate it\'s really helping me now',
				'property': 'profile_bio'
			}
		]
	}
